...
public class Livro {
	...
	public String toString() {
		return "LivroEntity [id=" + id + ", idAutor=" + idAutor + ", idCategoriaLivro=" + idCategoriaLivro
				+ ", idEditora=" + idEditora + ", nomeAutor=" + nomeAutor + ", categoriaLivro=" + categoriaLivro
				+ ", editora=" + editora + ", isbn=" + isbn + ", tituloLivro=" + tituloLivro + ", dataPublicacao="
				+ dataPublicacao + ", formato=" + formato + ", numeroPaginas=" + numeroPaginas + ", sumario=" + sumario
				+ ", resumo=" + resumo + ", precoCusto=" + precoCusto + ", precoVenda=" + precoVenda + ", margemLucro="
				+ margemLucro + ", qtdeEmEstoque=" + qtdeEmEstoque + ", imagem=" + imagem + ", imagePath=" + imagePath
				+ "]";
	}
