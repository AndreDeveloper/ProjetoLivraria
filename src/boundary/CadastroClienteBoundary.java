...
public class CadastroClienteBoundary implements ActionListener {
	...
	public JComponent Norte() {
		...
		JLabel lblTitulo = new JLabel("Identificaçao - Faaa seu cadastro");
	...
	public boolean ValidaCampos() {
		...
		if (nome.getText().length() <= 0) {
			...
			JOptionPane.showMessageDialog(null, "O UF deve ser informado", "Atençao", JOptionPane.WARNING_MESSAGE);
			uf.requestFocus();
			return false;
		} else if (cidade.getText().length() <= 0) {
			JOptionPane.showMessageDialog(null, "O Cidade deve ser informado", "Atençao", JOptionPane.WARNING_MESSAGE);
			cidade.requestFocus();
			return false;
			...
			JOptionPane.showMessageDialog(null, "O senha deve ser informado", "Atençao", JOptionPane.WARNING_MESSAGE);
			senha.requestFocus();
			return false;
